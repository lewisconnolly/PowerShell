...
$origVcenterRecord = Get-DnsServerResourceRecord -Name vcenterc01 -ZoneName domain.local -ComputerName dca-utl-dc1
$origVcenterRecord | Remove-DnsServerResourceRecord -ZoneName domain.local -ComputerName dca-utl-dc1  
...
Add-DnsServerResourceRecord -ZoneName domain.local -ComputerName dca-utl-dc1 -CreatePtr -IPv4Address 172.31.2.5 -Name vcenterc01 -A 
...
Add-DnsServerResourceRecord -ZoneName domain.local -ComputerName dca-utl-dc1 -CreatePtr -IPv4Address 172.30.2.5 -Name vcenterc01 -A 
