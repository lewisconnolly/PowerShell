Invoke-WebRequest -Uri "http://tf-utl-vscripts.zonalconnect.local:8888/"
...
Invoke-WebRequest -Uri "http://tf-utl-vscripts.zonalconnect.local:8888/?command=$command"
Invoke-WebRequest -Uri "http://tf-utl-vscripts.zonalconnect.local:8888/?command=$command1"
